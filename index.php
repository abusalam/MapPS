    ...
    <head>
        ...
        <script>
            ...
            function getData() {
                ...
                icon234.image = 'http://labs.google.com/ridefinder/images/mm_20_yellow.png';
                icon234.shadow = 'http://labs.google.com/ridefinder/images/mm_20_shadow.png';

                icon233 = new google.maps.MarkerImage('images/233.png');
                icon233.image = 'http://labs.google.com/ridefinder/images/mm_20_yellow.png';
                icon233.shadow = 'http://labs.google.com/ridefinder/images/mm_20_shadow.png';
                ...
                for (i = 0; i < markers.length; i++) {
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        html: '<div style="height:300px"> <table><tbody><tr><td colspan="2">'
                                ...
                                + bdo_office + '</td></tr><tr><td> BDO NO:</td><td><a href="tel:' + bdo_no + '">'
        ...
        <div id="wrapper" class="container" >
            ...
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                ...
                <ul>
                    ...
                    <div id="AddlC" style="display:block;overflow:hidden">
                        <a href="javascript:show_hide();"><img src="images/down.png" align="left" />ADDITIONAL CRITERIA....</a>
                        PS NO :<input type="text" class="input-mini" name="ps_no" id="ps_no"  /></li>
            ...
            <div class="page_head" id="pHead">
                ...
                <table width="100%" class="" cellspacing="0">
                    <tr>
                        ...
                        <td align="left"><div><h2><a class="menu" id="showLeft" href="#nav">GIS MAPPING OF Polling Station</a></h2></div></td>
            ...
            <div class="block">
                <div class="gmap">
                    ...
                    <div id='gmap_canvas' style="position:relative; width:100%; height:400px;">
                        Click to "GIS MAPPING OF POLLING STATION" for menu, Select PC, Once you select it list of AC will be populated.
                        You can select individual AC(Optional) or you can select all. Selecting all AC will take some time to populate.
                        All other options are optional. It is provided to narrow down the search.<br />
                        Click on additional criteria for Vulnerable, Critical, LWE and Mobile Shadow Zone. All are optional
